...
import tech.annexflow.constraintlayout.core.motion.MotionWidget.Companion.UNSET
import tech.annexflow.constraintlayout.core.motion.key.MotionConstraintSet
import tech.annexflow.constraintlayout.core.motion.key.MotionKey
import tech.annexflow.constraintlayout.core.motion.key.MotionKeyAttributes
import tech.annexflow.constraintlayout.core.motion.key.MotionKeyCycle
...
import tech.annexflow.constraintlayout.core.motion.key.MotionKeyTrigger
import tech.annexflow.constraintlayout.core.motion.utils.CurveFit
import tech.annexflow.constraintlayout.core.motion.utils.DifferentialInterpolator
import tech.annexflow.constraintlayout.core.motion.utils.Easing
import tech.annexflow.constraintlayout.core.motion.utils.FloatRect
import tech.annexflow.constraintlayout.core.motion.utils.KeyCache
import tech.annexflow.constraintlayout.core.motion.utils.KeyCycleOscillator
import tech.annexflow.constraintlayout.core.motion.utils.KeyCycleOscillator.PathRotateSet
import tech.annexflow.constraintlayout.core.motion.utils.KeyFrameArray.CustomVar
import tech.annexflow.constraintlayout.core.motion.utils.Rect
import tech.annexflow.constraintlayout.core.motion.utils.SplineSet
import tech.annexflow.constraintlayout.core.motion.utils.TimeCycleSplineSet
import tech.annexflow.constraintlayout.core.motion.utils.TypedValues
import tech.annexflow.constraintlayout.core.motion.utils.TypedValues.MotionType
import tech.annexflow.constraintlayout.core.motion.utils.TypedValues.TransitionType
import tech.annexflow.constraintlayout.core.motion.utils.Utils
import tech.annexflow.constraintlayout.core.motion.utils.VelocityMatrix
import tech.annexflow.constraintlayout.core.motion.utils.ViewState
...
//            }
    ...
    fun positionKeyframe(
        ...
        val start = tech.annexflow.constraintlayout.core.motion.utils.FloatRect()
        start.left = mStartMotionPath.mX
        start.top = mStartMotionPath.mY
        start.right = start.left + mStartMotionPath.mWidth
        start.bottom = start.top + mStartMotionPath.mHeight
        val end = tech.annexflow.constraintlayout.core.motion.utils.FloatRect()
        end.left = mEndMotionPath.mX
        end.top = mEndMotionPath.mY
        end.right = end.left + mEndMotionPath.mWidth
        end.bottom = end.top + mEndMotionPath.mHeight
