...
// import androidx.constraintlayout.compose.core.motion.utils.ArcCurveFit
...
//        s.setup()
//        if (DEBUG) {
//            s.sample(java.lang.Runnable { println(s.mRes.getRotationZ()) })
//        }
...
//        s.setup()
//        if (DEBUG) {
//            s.sample(java.lang.Runnable { println(s.mRes.getRotationX()) })
//        }
//        s.mMotion.interpolate(s.mRes, 0.5f, (1000000 + 1000).toLong(), s.mCache)
...
//        s.setup()
//        if (DEBUG) {
//            s.sample(java.lang.Runnable { println(s.mRes.getRotationY()) })
//        }
//        s.mMotion.interpolate(s.mRes, 0.5f, (1000000 + 1000).toLong(), s.mCache)
...
//        s.setup()
//        if (DEBUG) {
//            s.sample(java.lang.Runnable { println(s.mRes.getTranslationX()) })
//        }
//        s.mMotion.interpolate(s.mRes, 0.5f, (1000000 + 1000).toLong(), s.mCache)
...
//        s.setup()
//        if (DEBUG) {
//            s.sample(java.lang.Runnable { println(s.mRes.getTranslationY()) })
//        }
//        s.mMotion.interpolate(s.mRes, 0.5f, (1000000 + 1000).toLong(), s.mCache)
...
//        s.setup()
//        if (DEBUG) {
//            s.sample(java.lang.Runnable { println(s.mRes.getTranslationZ()) })
//        }
//        s.mMotion.interpolate(s.mRes, 0.5f, (1000000 + 1000).toLong(), s.mCache)
...
//        s.setup()
//        if (DEBUG) {
//            s.sample(java.lang.Runnable { println(s.mRes.getScaleX()) })
//        }
//        s.mMotion.interpolate(s.mRes, 0.5f, (1000000 + 1000).toLong(), s.mCache)
...
//        s.setup()
//        if (DEBUG) {
//            s.sample(java.lang.Runnable { println(s.mRes.getScaleY()) })
//        }
//        s.mMotion.interpolate(s.mRes, 0.5f, (1000000 + 1000).toLong(), s.mCache)
...
//        s.setup()
//        if (DEBUG) {
//            s.sample(java.lang.Runnable { println(s.mRes.getPivotX()) })
//        }
//        s.mMotion.interpolate(s.mRes, 0.5f, (1000000 + 1000).toLong(), s.mCache)
...
//        s.setup()
//        if (DEBUG) {
//            s.sample(java.lang.Runnable { println(s.mRes.getPivotY()) })
//        }
//        s.mMotion.interpolate(s.mRes, 0.5f, (1000000 + 1000).toLong(), s.mCache)
