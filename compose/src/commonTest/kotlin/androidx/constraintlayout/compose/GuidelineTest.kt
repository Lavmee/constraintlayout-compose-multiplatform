...
class GuidelineTest {
    ...
    fun testWrapGuideline() {
        ...
        val guidelineRight = androidx.constraintlayout.compose.core.widgets.Guideline()
        guidelineRight.setOrientation(androidx.constraintlayout.compose.core.widgets.Guideline.VERTICAL)
        val guidelineBottom = androidx.constraintlayout.compose.core.widgets.Guideline()
        guidelineBottom.setOrientation(androidx.constraintlayout.compose.core.widgets.Guideline.HORIZONTAL)
    ...
    fun testWrapGuideline2() {
        ...
        guideline.setOrientation(androidx.constraintlayout.compose.core.widgets.Guideline.VERTICAL)
