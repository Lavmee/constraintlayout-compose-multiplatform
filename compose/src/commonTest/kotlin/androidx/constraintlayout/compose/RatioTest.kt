...
class RatioTest {
    ...
    fun testGuidelineRatioChainWrap() {
        ...
        val guideline = androidx.constraintlayout.compose.core.widgets.Guideline()
        guideline.setOrientation(androidx.constraintlayout.compose.core.widgets.Guideline.HORIZONTAL)
...
//        root.setWidth(0);
    ...
    fun testRatioMax() {
        ...
        root.optimizationLevel = androidx.constraintlayout.compose.core.widgets.Optimizer.OPTIMIZATION_NONE
        root.layout()
...
//        assertEquals(C.getBottom() <= B.getBottom(), true);
    ...
    fun testNestedRatio4() {
        ...
        val verticalGuideline = androidx.constraintlayout.compose.core.widgets.Guideline()
        verticalGuideline.setGuidePercent(0.34f)
        verticalGuideline.setOrientation(androidx.constraintlayout.compose.core.widgets.Guideline.VERTICAL)
        val horizontalGuideline = androidx.constraintlayout.compose.core.widgets.Guideline()
        horizontalGuideline.setGuidePercent(0.66f)
        horizontalGuideline.setOrientation(androidx.constraintlayout.compose.core.widgets.Guideline.HORIZONTAL)
        root.debugName = "root"
        a.debugName = "A"
        b.debugName = "B"
        ...
        assertEquals(verticalGuideline.left, 0.34f * root.width, 1f)
        assertEquals(horizontalGuideline.top, 0.66f * root.height, 1f)
        assertTrue(a.left >= 0)
        assertTrue(b.left >= 0)
    ...
    fun testBasicCenter() {
        ...
        root.optimizationLevel =
            androidx.constraintlayout.compose.core.widgets.Optimizer.OPTIMIZATION_STANDARD
        root.layout()
