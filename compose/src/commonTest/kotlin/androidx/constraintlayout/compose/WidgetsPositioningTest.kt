...
//                assertEquals(b.top - a.top, ((a.height - b.height) / 2) as Int)
//                assertEquals(
//                    a.bottom - b.bottom,
//                    ((a.height - b.height) / 2) as Int
//                )
...
//                assertEquals(b.left - a.left, ((a.width - b.width) / 2) as Int)
//                assertEquals(
//                    a.right - b.right,
//                    ((a.width - b.width) / 2) as Int
//                )
//            }
//        })
...
//        check: Runnable
//    ) {
//        val tail: ArrayList<Int> = ArrayList<Int>()
//        for (i in widgets.indices) {
//            tail.add(i)
//        }
