...
class MatchConstraintTest {
    ...
    fun testMinMaxMatch() {
        val root = ConstraintWidgetContainer(0, 0, 800, 600)
        val guidelineA = androidx.constraintlayout.compose.core.widgets.Guideline()
        guidelineA.setOrientation(androidx.constraintlayout.compose.core.widgets.Guideline.VERTICAL)
        guidelineA.setGuideBegin(100)
        val guidelineB = androidx.constraintlayout.compose.core.widgets.Guideline()
        guidelineB.setOrientation(androidx.constraintlayout.compose.core.widgets.Guideline.VERTICAL)
