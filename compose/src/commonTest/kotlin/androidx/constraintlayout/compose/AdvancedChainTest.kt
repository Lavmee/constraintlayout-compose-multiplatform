...
class AdvancedChainTest {
    ...
    fun testComplexChainWeights() {
        ...
        a.connect(
            androidx.constraintlayout.compose.core.widgets.ConstraintAnchor.Type.LEFT,
            root,
            androidx.constraintlayout.compose.core.widgets.ConstraintAnchor.Type.LEFT,
        )
        a.connect(
            androidx.constraintlayout.compose.core.widgets.ConstraintAnchor.Type.RIGHT,
            root,
            androidx.constraintlayout.compose.core.widgets.ConstraintAnchor.Type.RIGHT,
        )
        b.connect(
        ...
        a.connect(
            androidx.constraintlayout.compose.core.widgets.ConstraintAnchor.Type.TOP,
            root,
            androidx.constraintlayout.compose.core.widgets.ConstraintAnchor.Type.TOP,
            0,
        )
        a.connect(
            androidx.constraintlayout.compose.core.widgets.ConstraintAnchor.Type.BOTTOM,
            b,
            androidx.constraintlayout.compose.core.widgets.ConstraintAnchor.Type.TOP,
            0,
        )
