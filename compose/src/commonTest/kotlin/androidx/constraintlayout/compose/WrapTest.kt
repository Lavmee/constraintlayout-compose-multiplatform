...
class WrapTest {
    ...
    fun testWrap4() {
        ...
        val barrier1 = androidx.constraintlayout.compose.core.widgets.Barrier()
        barrier1.setBarrierType(androidx.constraintlayout.compose.core.widgets.Barrier.BOTTOM)
        val barrier2 = androidx.constraintlayout.compose.core.widgets.Barrier()
        barrier2.setBarrierType(androidx.constraintlayout.compose.core.widgets.Barrier.BOTTOM)
        barrier1.add(a)
        barrier1.add(b)
        barrier2.add(c)
        root.debugName = "root"
    ...
    fun testBarrierWrap() {
        ...
        val barrier = androidx.constraintlayout.compose.core.widgets.Barrier()
        barrier.setBarrierType(androidx.constraintlayout.compose.core.widgets.Barrier.BOTTOM)
        barrier.add(button)
        barrier.add(space)
        root.debugName = "root"
        view.debugName = "view"
