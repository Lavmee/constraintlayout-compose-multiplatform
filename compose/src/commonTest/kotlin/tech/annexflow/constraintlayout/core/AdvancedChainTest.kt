...
class AdvancedChainTest {
    ...
    fun testComplexChainWeights() {
        ...
        a.connect(
            tech.annexflow.constraintlayout.core.widgets.ConstraintAnchor.Type.LEFT,
            root,
            tech.annexflow.constraintlayout.core.widgets.ConstraintAnchor.Type.LEFT,
        )
        a.connect(
            tech.annexflow.constraintlayout.core.widgets.ConstraintAnchor.Type.RIGHT,
            root,
            tech.annexflow.constraintlayout.core.widgets.ConstraintAnchor.Type.RIGHT,
        )
        b.connect(
        ...
        a.connect(
            tech.annexflow.constraintlayout.core.widgets.ConstraintAnchor.Type.TOP,
            root,
            tech.annexflow.constraintlayout.core.widgets.ConstraintAnchor.Type.TOP,
            0,
        )
        a.connect(
            tech.annexflow.constraintlayout.core.widgets.ConstraintAnchor.Type.BOTTOM,
            b,
            tech.annexflow.constraintlayout.core.widgets.ConstraintAnchor.Type.TOP,
            0,
        )
