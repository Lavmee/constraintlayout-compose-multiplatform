...
class WrapTest {
    ...
    fun testWrap4() {
        ...
        val barrier1 = tech.annexflow.constraintlayout.core.widgets.Barrier()
        barrier1.setBarrierType(tech.annexflow.constraintlayout.core.widgets.Barrier.BOTTOM)
        val barrier2 = tech.annexflow.constraintlayout.core.widgets.Barrier()
        barrier2.setBarrierType(tech.annexflow.constraintlayout.core.widgets.Barrier.BOTTOM)
        barrier1.add(a)
        barrier1.add(b)
        barrier2.add(c)
        root.debugName = "root"
    ...
    fun testBarrierWrap() {
        ...
        val barrier = tech.annexflow.constraintlayout.core.widgets.Barrier()
        barrier.setBarrierType(tech.annexflow.constraintlayout.core.widgets.Barrier.BOTTOM)
        barrier.add(button)
        barrier.add(space)
        root.debugName = "root"
        view.debugName = "view"
