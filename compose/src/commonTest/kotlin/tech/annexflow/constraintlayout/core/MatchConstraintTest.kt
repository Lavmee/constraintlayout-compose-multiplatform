...
class MatchConstraintTest {
    ...
    fun testMinMaxMatch() {
        val root = ConstraintWidgetContainer(0, 0, 800, 600)
        val guidelineA = tech.annexflow.constraintlayout.core.widgets.Guideline()
        guidelineA.setOrientation(tech.annexflow.constraintlayout.core.widgets.Guideline.VERTICAL)
        guidelineA.setGuideBegin(100)
        val guidelineB = tech.annexflow.constraintlayout.core.widgets.Guideline()
        guidelineB.setOrientation(tech.annexflow.constraintlayout.core.widgets.Guideline.VERTICAL)
