...
class RatioTest {
    ...
    fun testGuidelineRatioChainWrap() {
        ...
        guideline.setOrientation(tech.annexflow.constraintlayout.core.widgets.Guideline.HORIZONTAL)
...
//        root.setWidth(0);
    ...
    fun testRatioMax() {
        ...
        root.optimizationLevel = tech.annexflow.constraintlayout.core.widgets.Optimizer.OPTIMIZATION_NONE
        root.layout()
...
//        assertEquals(C.getBottom() <= B.getBottom(), true);
    ...
    fun testNestedRatio4() {
        ...
        val verticalGuideline = tech.annexflow.constraintlayout.core.widgets.Guideline()
        verticalGuideline.setGuidePercent(0.34f)
        verticalGuideline.setOrientation(tech.annexflow.constraintlayout.core.widgets.Guideline.VERTICAL)
        val horizontalGuideline = tech.annexflow.constraintlayout.core.widgets.Guideline()
        horizontalGuideline.setGuidePercent(0.66f)
        horizontalGuideline.setOrientation(tech.annexflow.constraintlayout.core.widgets.Guideline.HORIZONTAL)
        root.debugName = "root"
        a.debugName = "A"
        b.debugName = "B"
    ...
    fun testBasicCenter() {
        ...
        root.optimizationLevel =
            tech.annexflow.constraintlayout.core.widgets.Optimizer.OPTIMIZATION_STANDARD
        root.layout()
